...
module.exports = function (options) {
  ...
  function cmd_define_spec (args, done) {
    validate_spec(args.spec, function (err) {
      if (err) { return done(null, { ok: false, kind: args.kind, err: err }) }
  ...
  seneca.act_if(options.web, {role: 'web', use: {
    ...
    endware: function (req, res, next) {
      if (req.url.indexOf(options.prefix) !== 0) return next()
